...
function DialogDescription({
  ...
  return (
    <DialogPrimitive.Description
      ...
      className={cn(
        "text-label text-text-3 *:[a]:underline *:[a]:underline-offset-3 *:[a]:hover:text-text-1",
        className
      )}
      {...props}
    />
